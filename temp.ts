[
  ...
  {
    name: 'Butterfly Croptop',
    fileName: 'butterfly-2.png',
    description: 'It is a little tighter than Naomi expected...',
    alt: 'Naomi wearing a black crop top with a butterfly cutout and a black miniskirt.',
    credits: {
      top: 'https://booth.pm/en/items/4716465',
      skirt: 'https://booth.pm/en/items/4716433',
    },
  },
  {
    name: 'Casual Wear 2',
  ...
  },
  {
    ...
    alt: 'Naomi wearing a short pencil skirt dress with a plunging neck line.',
    credits: {
      outfit: 'https://booth.pm/en/items/4539843',
    },
  },
  {
    name: 'Exercise Gear',
  ...
  },
  {
    name: 'Gem Dress',
    fileName: 'gem.png',
    description: 'The gem is a lot heavier than it looks.',
    alt: 'Naomi wearing a purple heart-shaped gem tanktop, and a purple plaid miniskirt.',
    credits: {
      top: 'https://booth.pm/en/items/4536195',
      skirt: 'https://booth.pm/en/items/3398295',
    },
  },
  {
    name: 'Glam Dress',
  ...
  {
    name: 'Green Rave Outfit',
    fileName: 'green.png',
    description:
      'For someone who never leaves the house, Naomi has a lot of rave outfits.',
    alt: 'Naomi wearing a black crop top and miniskirt with neon green accents, and neon green mesh sleeves and stockings.',
    credits: {
      outfit: 'https://booth.pm/en/items/4708923',
    },
  },
  {
    name: 'Naomi Gura',
  ...
  {
    name: 'Snowflake Dress',
    fileName: 'snowflake.png',
    description: 'Probably too long to actually wear in the snow.',
    alt: 'Naomi wearing a white and blue dress with a snowflake pattern along the hem.',
    credits: {
      outfit: 'https://booth.pm/en/items/4720259',
    },
  },
  {
    name: 'Sorceress Gown',
